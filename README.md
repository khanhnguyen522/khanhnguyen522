...
- **Languages** — C#, TypeScript, JavaScript, Python, Java, SQL, C/C++
- **Frontend** — React, Angular, NgRx, Redux, Material UI, Tailwind
- **Backend** — .NET Core, Node.js, Express.js, Flask, Docker
- **Cloud & Data** — AWS, Microsoft Azure, SQL Server, PostgreSQL, Cosmos DB, MongoDB, Redis
